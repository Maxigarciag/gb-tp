 ...
 */
export const LazyHome = createLazyComponent(() => import('@/features/home/pages/home'));
...
export const LazyCustomExercisesManager = createLazyComponent(() => import('@/features/rutinas/pages/ejercicios-personalizados'))
