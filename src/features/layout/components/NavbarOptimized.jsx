...
import UserProfileOptimized from '@/features/usuario/components/UserProfileOptimized'
import ThemeToggleOptimized from '@/features/theme/components/ThemeToggleOptimized'
          ...
          {isAuthenticated && (
            <>
              ...
              <Link 
                ...
                onMouseEnter={() => import('@/features/progreso/pages/progreso.jsx')}
              >
                <BarChart2 size={16} />
                Progreso
              </Link>
              <Link 
                to="/nutricion"
                className={isActive("/nutricion") ? "active" : ""}
      ...
      {isAuthenticated && (
        ...
        >
          <div className="bottom-nav-container">
            ...
            <Link 
              to="/nutricion"
              className={`bottom-nav-item ${isActive("/nutricion") ? "active" : ""}`}
            ...
            >
              ...
              >
                <div className="bottom-nav-icon">
                  <UtensilsCrossed size={22} strokeWidth={isActive("/nutricion") ? 2.5 : 2} />
                </div>
              </motion.div>
              <motion.span 
                className="bottom-nav-label"
                animate={{ 
                  opacity: isActive("/nutricion") ? 1 : 0.7,
                  scale: isActive("/nutricion") ? 1 : 0.95
                }}
                transition={{ duration: 0.2 }}
              >
                Nutrición
